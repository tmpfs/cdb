...
var SecurityDocument = require('./security');
var DesignDocument = require('./design');
...
var Server = function(options) {
  ...
  this.doc = new DatabaseDocument(options);
  this.att = new Attachment(options);
  this.sec = new SecurityDocument(options);
  this.design = new DesignDocument(options);
