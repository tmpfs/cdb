...
function revision(opts, cb) {
  ...
  // attempt to get latest revision
    ...
    return DatabaseDocument.prototype.head.call(scope, opts, function onhead(err, res, doc) {
 ...
 */
Attachment.prototype.put = function(opts, cb) {
  var scope = this;
 ...
 */
Attachment.prototype.get = function(opts, cb) {
  var scope = this;
  opts = this.merge(opts);
 ...
 */
Attachment.prototype.rm = function(opts, cb) {
  var scope = this;
  opts = this.merge(opts);
 ...
 */
Attachment.prototype.head = function(opts, cb) {
  opts = this.merge(opts);
  assert(opts.id, 'document id required to get attachment')
  assert(opts.attname, 'attachment name required to get attachment');
  var u = this.url([opts.server, opts.db, opts.id, opts.attname]);
